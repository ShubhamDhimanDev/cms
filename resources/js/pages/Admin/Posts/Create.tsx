...
import type { Category, PostBlock } from '@/types/cms';
...
export default function CreatePost({ categories }: Props) {
    ...
    const submit = (event: FormEvent) => {
        ...
        form.post(postRoutes.store.url(), {
            forceFormData: true,
        });
    };
            ...
            <div className="mx-auto max-w-3xl space-y-4">
                ...
                <form onSubmit={submit} className="space-y-5 rounded-2xl border border-neutral-200 bg-white p-5 shadow-sm">
                    ...
                    <div className="grid gap-2">
                        ...
                        {form.data.featured_image_url && !form.data.featured_image ? (
                            <div className="relative mt-1 w-40">
                                <img
                                    src={form.data.featured_image_url}
                                    alt="Selected from media"
                                    className="h-28 w-40 rounded-md border border-neutral-200 object-cover"
                                />
                                <button
                                    type="button"
                                    onClick={() => form.setData('featured_image_url', '')}
...
CreatePost.layout = withAdminLayout;
